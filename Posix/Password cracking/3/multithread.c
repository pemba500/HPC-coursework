...
void PassCracks(){
 ...
 for(p=0; p<num_password; p++)
 { 
  pthread_create(&thread_1, NULL, kernel_function_1, encrypted_pwd[p]);
  pthread_create(&thread_2, NULL, kernel_function_2, encrypted_pwd[p]);
